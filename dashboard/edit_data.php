 ...
 <div class="form-group mb-4">
    ...
    <div class="form-row mb-4">
        ...
        <table class="check_form" id="pengecekan">
            ...
            <tr><td>5</td><td>Lubang</td><td><input type="radio" name="5,1" value="Ada" checked/>Ada<br/><input type="radio" name="5,1" value="Tidak"/>Tidak</td><td><input type="radio" name="5,2" value="Ada" checked/>Ada<br/><input type="radio" name="5,2" value="Tidak"/>Tidak</td><td><input type="radio" name="5,3" value="Ada" checked/>Ada<br/><input type="radio" name="5,3" value="Tidak"/>Tidak</td><td><input type="radio" name="5,4" value="Ada" checked/>Ada<br/><input type="radio" name="5,4" value="Tidak"/>Tidak</td><td><input type="radio" name="5,5" value="Ada" checked/>Ada<br/><input type="radio" name="5,5" value="Tidak"/>Tidak</td><td><input type="radio" name="5,6" value="Ada" checked/>Ada<br/><input type="radio" name="5,6" value="Tidak"/>Tidak</td><td><input type="radio" name="5,7" value="Ada" checked/>Ada<br/><input type="radio" name="5,7" value="Tidak"/>Tidak</td><td><input type="radio" name="5,8" value="Ada" checked/>Ada<br/><input type="radio" name="5,8" value="Tidak"/>Tidak</td></tr>
            ...
            <tr><td>7</td><td>Terdapat Bari atau Mata ikan</td><td><input type="radio" name="7,1" value="Ada" checked/>Ada<br/><input type="radio" name="7,1" value="Tidak"/>Tidak</td><td><input type="radio" name="7,2" value="Ada" checked/>Ada<br/><input type="radio" name="7,2" value="Tidak"/>Tidak</td><td><input type="radio" name="7,3" value="Ada" checked/>Ada<br/><input type="radio" name="7,3" value="Tidak"/>Tidak</td><td><input type="radio" name="7,4" value="Ada" checked/>Ada<br/><input type="radio" name="7,4" value="Tidak"/>Tidak</td><td><input type="radio" name="7,5" value="Ada" checked/>Ada<br/><input type="radio" name="7,5" value="Tidak"/>Tidak</td><td><input type="radio" name="7,6" value="Ada" checked/>Ada<br/><input type="radio" name="7,6" value="Tidak"/>Tidak</td><td><input type="radio" name="7,7" value="Ada" checked/>Ada<br/><input type="radio" name="7,7" value="Tidak"/>Tidak</td><td><input type="radio" name="7,8" value="Ada" checked/>Ada<br/><input type="radio" name="7,8" value="Tidak"/>Tidak</td></tr>
        </table>
    </div>
                                                ';
                                            }
