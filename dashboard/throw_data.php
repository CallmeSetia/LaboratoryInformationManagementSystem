...
function throwData() {
    ...
    if (strtolower((string) $inD_buffer[0]) == "pc") {
        if (grabData("pc", $inD_buffer[1]) == $inD_buffer[1]) {
            $sql_update = "UPDATE tbl_detail_pkg_pc SET tgl_cek='" . $_POST['tgl_cek'] . "', approval = '". $_POST['approval'] . "', jml_produk = '". $_POST['jumlahProduct'] . "', cek_sampel = '". $_POST['cekSampel'] ."', warna_cap = '". $_POST['1,1'] . "#" . $_POST['1,2'] . "#" . $_POST['1,3'] . "#" . $_POST['1,4'] . "#" . $_POST['1,5'] . "#" . $_POST['1,6'] . "#" . $_POST['1,7'] . "#" . $_POST['1,8'] ."', kotoran = '". $_POST['2,1'] . "#" . $_POST['2,2'] . "#" . $_POST['2,3'] . "#" . $_POST['2,4'] . "#" . $_POST['2,5'] . "#" . $_POST['2,6'] . "#" . $_POST['2,7'] . "#" . $_POST['2,8'] ."', goresan_pc = '". $_POST['3,1'] . "#" . $_POST['3,2'] . "#" . $_POST['3,3'] . "#" . $_POST['3,4'] . "#" . $_POST['3,5'] . "#" . $_POST['3,6'] . "#" . $_POST['3,7'] . "#" . $_POST['3,8'] ."', cacat_pc = '". $_POST['4,1'] . "#" . $_POST['4,2'] . "#" . $_POST['4,3'] . "#" . $_POST['4,4'] . "#" . $_POST['4,5'] . "#" . $_POST['4,6'] . "#" . $_POST['4,7'] . "#" . $_POST['4,8'] ."', lubang = '". $_POST['5,1'] . "#" . $_POST['5,2'] . "#" . $_POST['5,3'] . "#" . $_POST['5,4'] . "#" . $_POST['5,5'] . "#" . $_POST['5,6'] . "#" . $_POST['5,7'] . "#" . $_POST['5,8'] ."', kondisi_seal = '". $_POST['6,1'] . "#" . $_POST['6,2'] . "#" . $_POST['6,3'] . "#" . $_POST['6,4'] . "#" . $_POST['6,5'] . "#" . $_POST['6,6'] . "#" . $_POST['6,7'] . "#" . $_POST['6,8'] ."', terdapat_bami = '". $_POST['7,1'] . "#" . $_POST['7,2'] . "#" . $_POST['7,3'] . "#" . $_POST['7,4'] . "#" . $_POST['7,5'] . "#" . $_POST['7,6'] . "#" . $_POST['7,7'] . "#" . $_POST['7,8'] ."' WHERE id_pm=" . $inD_buffer[1];
        ...
        if (grabData("ibc", $inD_buffer[1]) == $inD_buffer[1]) {
            $sql_update = "UPDATE tbl_detail_pkg_ibc SET tgl_cek='" . $_POST['tgl_cek'] . "', approval = '". $_POST['approval'] . "', jml_produk = '". $_POST['jumlahProduct'] . "', cek_sampel = '". $_POST['cekSampel'] ."', kondisi_vn = '". $_POST['1,1'] . "#" . $_POST['1,2'] . "#" . $_POST['1,3'] . "#" . $_POST['1,4'] . "#" . $_POST['1,5'] . "#" . $_POST['1,6'] . "#" . $_POST['1,7'] . "#" . $_POST['1,8'] ."', terdapat_lk = '". $_POST['2,1'] . "#" . $_POST['2,2'] . "#" . $_POST['2,3'] . "#" . $_POST['2,4'] . "#" . $_POST['2,5'] . "#" . $_POST['2,6'] . "#" . $_POST['2,7'] . "#" . $_POST['2,8'] ."', kotoran = '". $_POST['3,1'] . "#" . $_POST['3,2'] . "#" . $_POST['3,3'] . "#" . $_POST['3,4'] . "#" . $_POST['3,5'] . "#" . $_POST['3,6'] . "#" . $_POST['3,7'] . "#" . $_POST['3,8'] ."', air_oli = '". $_POST['4,1'] . "#" . $_POST['4,2'] . "#" . $_POST['4,3'] . "#" . $_POST['4,4'] . "#" . $_POST['4,5'] . "#" . $_POST['4,6'] . "#" . $_POST['4,7'] . "#" . $_POST['4,8'] ."' WHERE id_pm=" . $inD_buffer[1];
            if ($conn->query($sql_update) === TRUE) {
                echo "Data telah diperbarui!";
            } else {
                echo "Data gagal diperbarui!";
        ...
        if (grabData("pcb", $inD_buffer[1]) == $inD_buffer[1]) {
            $sql_update = "UPDATE tbl_detail_pkg_pcb SET tgl_cek='" . $_POST['tgl_cek'] . "', approval = '". $_POST['approval'] . "', jml_produk = '". $_POST['jumlahProduct'] . "', cek_sampel = '". $_POST['cekSampel'] ."', kondisi_cart = '". $_POST['1,1'] . "#" . $_POST['1,2'] . "#" . $_POST['1,3'] . "#" . $_POST['1,4'] . "#" . $_POST['1,5'] . "#" . $_POST['1,6'] . "#" . $_POST['1,7'] . "#" . $_POST['1,8'] ."', warna_cart = '". $_POST['2,1'] . "#" . $_POST['2,2'] . "#" . $_POST['2,3'] . "#" . $_POST['2,4'] . "#" . $_POST['2,5'] . "#" . $_POST['2,6'] . "#" . $_POST['2,7'] . "#" . $_POST['2,8'] ."', kotoran_l = '". $_POST['3,1'] . "#" . $_POST['3,2'] . "#" . $_POST['3,3'] . "#" . $_POST['3,4'] . "#" . $_POST['3,5'] . "#" . $_POST['3,6'] . "#" . $_POST['3,7'] . "#" . $_POST['3,8'] ."', gambar = '". $_POST['4,1'] . "#" . $_POST['4,2'] . "#" . $_POST['4,3'] . "#" . $_POST['4,4'] . "#" . $_POST['4,5'] . "#" . $_POST['4,6'] . "#" . $_POST['4,7'] . "#" . $_POST['4,8'] ."', label = '". $_POST['5,1'] . "#" . $_POST['5,2'] . "#" . $_POST['5,3'] . "#" . $_POST['5,4'] . "#" . $_POST['5,5'] . "#" . $_POST['5,6'] . "#" . $_POST['5,7'] . "#" . $_POST['5,8'] ."', kotoran_d = '". $_POST['6,1'] . "#" . $_POST['6,2'] . "#" . $_POST['6,3'] . "#" . $_POST['6,4'] . "#" . $_POST['6,5'] . "#" . $_POST['6,6'] . "#" . $_POST['6,7'] . "#" . $_POST['6,8'] ."', coa = '". $_POST['COA'] ."' WHERE id_pm=" . $inD_buffer[1];
            if ($conn->query($sql_update) === TRUE) {
                echo "Data telah diperbarui!";
            } else {
                echo "Data gagal diperbarui!";
